...
inline PROTOBUF_ALWAYS_INLINE void RpcHeader::set_server_name(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void RpcHeader::set_allocated_server_name(std::string* value) {
...
inline PROTOBUF_ALWAYS_INLINE void RpcHeader::set_method_name(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.method_name_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
